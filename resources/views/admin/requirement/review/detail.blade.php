...
<form id="detail-form">
        ...
        <div class="card-body">
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input value="<?php echo isset($detail['user_name']) ? $detail['user_name'] : '' ?>" type="text" name="user_name" class="form-control" id="user_name" required>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="card-body">
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <span class="float-right badge badge-danger">必須</span>
              <input value="<?php echo isset($detail['review_score']) ? $detail['review_score'] : 0 ?>" type="number" name="review_score" class="form-control" id="review_score" required>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            $detail['img'][0]['name'] : ''])
            <input value="<?php echo isset($detail['img'][0]) ? $detail['img'][0]['alt'] : '' ?>" type="hidden" name="img1_alt" class="form-control form-control-sm mt-2">
          </div>
        </div>
        <?php for ($i = 2; $i < 6; $i++) : ?>
          <?php $name = 'img' . $i; ?>
          ...
          <div class="col-md-4 <?php echo $_v ? '' : 'd-none'; ?>">
            <div class="form-group">
              ...
              <input value="<?php echo isset($detail['img'][$i - 1]) ? $detail['img'][$i - 1]['alt'] : '' ?>" type="hidden" name="<?php echo $name; ?>_alt" class="form-control form-control-sm mt-2">
            </div>
          </div>
        <?php endfor; ?>
        <div class="col-md-4">
          <div class="form-group">
            <label for="heading">　</label>
            <button type="button" class="btn btn-outline-primary btn-lg btn-block" id="add-image"><i class="fas fa-plus-circle fa-3x"></i></button>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <span class="float-right badge badge-danger">必須</span>
            <textarea class="mysummernote" name="content" required><?php echo isset($detail['content']) ? $detail['content'] : '' ?></textarea>
          </div>
        </div>
      </div>
      <!-- /.row -->
  ...
  <footer class="main-footer">
    <div class="row">
      <div class="col-6">
        <a href="/admin/requirement/review/list" id="btn-list-back" class="btn btn-link pl-1"><i class="fa fa-backward"></i><span> 一覧に戻る</span></a>
