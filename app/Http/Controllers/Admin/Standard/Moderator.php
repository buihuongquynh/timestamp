...
class Moderator extends Base
{
  public function getList()
  {
    ...
    return view('admin.standard.moderator.list', ['title' => 'メンバー管理 | 一覧']);
  }
  ...
  public function getDetail($id = null)
  {
    ...
    return view('admin.standard.moderator.detail', ['title' => 'メンバー管理 | 詳細', 'detail' => json_decode(json_encode($detail), true)]);
  }
